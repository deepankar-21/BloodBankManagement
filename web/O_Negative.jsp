<%-- 
    Document   : O_Negative
    Created on : Jun 3, 2021, 12:33:24 PM
    Author     : anura
--%>
                                         ...
                                         <table class="table table-striped table-hover">
                                             ...
                                             <tbody>
                                                 ...
                                                 <tr class="text-center">
                                                     ...
                                                     <td><button class="btn btn-danger edit_on_doner" data-toggle="modal" ><i class="fa fa-edit">&nbsp;</i></button></td>
                                           ...
                                           <!--Edit O- Blood Doner-->       
   <div class="modal fade" id="edit_on_doner" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body bg-dark text-white">
          <form id="an_form" action="edit_on_doner.jsp">
...
<script type="text/javascript" src="files/boot3.js"></script>
    ...
    <script>
        $(document).ready(function(){      
                     $('.edit_on_doner').on('click',function(){
                     $('#edit_on_doner').modal('show');
                     $tr=$(this).closest('tr');   
