<%-- 
    Document   : O_Positive
    Created on : Jun 3, 2021, 12:21:26 PM
    Author     : anura
--%>
                                     ...
                                     <div class="col-lg-12 col-md-12 col-sm-12">
                                         <table class="table table-striped table-hover">
                                             <thead class="bg-dark text-white text-center">
                                                 <tr colspan="6"><h3>O+ Blood Doner's</h3></tr>
                                                 <tr>
                                                     <th>#</th>
                                                     <th>Name</th>
                                                     <th>Mobile</th>
                                             ...
                                             <tbody>
                                                 <%
                                                     ...
                                                     db.pstmt=db.con.prepareStatement("select * from doner where bloodgroup='O+'");
                                                     db.rst=db.pstmt.executeQuery();
                                                     while(db.rst.next())
                                                     {                
                                                 ...
                                                 <tr class="text-center">
                                                     ...
                                                     <td><button class="btn btn-danger edit_op_doner" data-toggle="modal" ><i class="fa fa-edit">&nbsp;</i></button></td>
                                           ...
                                           <!--Edit O+ Blood Doner-->       
   <div class="modal fade" id="edit_op_doner" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-danger text-white card-header">
        <h5 class="modal-title" id="exampleModelModel">Update O+ Doner</h5>
        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body bg-dark text-white">
          <form id="an_form" action="edit_op_doner.jsp">
...
<script type="text/javascript" src="files/boot3.js"></script>
    ...
    <script>
        $(document).ready(function(){      
                     $('.edit_op_doner').on('click',function(){
                     $('#edit_op_doner').modal('show');
                     $tr=$(this).closest('tr');   
